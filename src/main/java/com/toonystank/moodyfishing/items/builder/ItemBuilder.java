package com.toonystank.moodyfishing.items.builder;

import com.mojang.authlib.GameProfile;
import com.mojang.authlib.properties.Property;
import com.toonystank.moodyfishing.utils.SkullUtil;
...
public class ItemBuilder extends BaseItemBuilder<ItemBuilder> {
     ...
     * @return A new {@link BannerBuilder}
     * @throws IllegalArgumentException if the item is not a BANNER
     * @since 3.0.1
     */
    @NotNull
    @Contract("_ -> new")
     ...
     * @throws IllegalArgumentException if the item type is not {@link Material#WRITABLE_BOOK}
     ...
     * @return A new {@link .FireworkBuilder}
     * @throws IllegalArgumentException if the item type is not {@link Material#FIREWORK_ROCKET}
     * @since 3.0.1
     */
    @NotNull
    @Contract("_ -> new")
     ...
     * @return A new {@link MapBuilder}
     * @throws IllegalArgumentException if the item type is not {@link Material#MAP}
     * @since 3.0.1
     */
    @NotNull
    @Contract("_ -> new")
     ...
     * @return A new {@link FireworkBuilder}
     * @throws IllegalArgumentException if the item type is not {@link Material#FIREWORK_STAR}
     * @since 3.0.1
     */
    @NotNull
    @Contract("_ -> new")
