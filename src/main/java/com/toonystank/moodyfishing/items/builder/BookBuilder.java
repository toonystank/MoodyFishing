...
import com.toonystank.moodyfishing.utils.Legacy;
...
public class BookBuilder extends BaseItemBuilder<BookBuilder> {
    ...
    BookBuilder(@NotNull ItemStack itemStack) {
        ...
        if (!BOOKS.contains(itemStack.getType())) {
            throw new IllegalArgumentException("BookBuilder requires the material to be a WRITABLE_BOOK/WRITTEN_BOOK!");
        }
    }
