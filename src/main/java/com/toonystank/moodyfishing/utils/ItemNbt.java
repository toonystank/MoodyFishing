...
import com.toonystank.moodyfishing.items.builder.nbt.LegacyNbt;
import com.toonystank.moodyfishing.items.builder.nbt.NbtWrapper;
import com.toonystank.moodyfishing.items.builder.nbt.Pdc;
import org.bukkit.inventory.ItemStack;
import org.jetbrains.annotations.NotNull;

/**
 * Ideally this wouldn't need to be a util, but because of the {@link LegacyNbt} it makes it easier. Legacy.
 * Will use the PDC wrapper if a version is higher than 1.14
 */
public final class ItemNbt {
    ...
    /**
     * Selects which {@link NbtWrapper} to use based on a server version.
     *
     * @return A {@link NbtWrapper} implementation, {@link Pdc} if a version is higher than 1.14 and {@link LegacyNbt} if not.
     */
